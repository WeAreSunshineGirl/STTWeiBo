...
class WBComposeVController: UIViewController {
    /// 文本编辑视图
...
extension WBComposeVController:UITextViewDelegate{
    /**
     文本视图文字变化
     */
...
private extension WBComposeVController{
    func setupUI() {
